        ...
        return (
            <div>
                ...
                <section className="project-page-section">
                    ...
                    <div className="row">
                        <img className="col-md-3 col-sm-6" src={process.env.PUBLIC_URL + '/images/p1_old_admin_shift_times.png'} alt="old shift schedule admin screenshot" />
                    </div>
                    ...
                    <div className="row">
                        <img className="col-md-3 col-sm-6" src={process.env.PUBLIC_URL + '/images/p1_old_admin_targets.png'} alt="old target values admin screenshot" />
                    </div>
                    ...
                    <div className="row">
                        <img className="col-md-7 col-sm-10" src={process.env.PUBLIC_URL + '/images/p1_old_admin_navigation.png'} alt="old admin navigation screenshot" />
                    </div>
                </section>
                ...
                <section className="project-page-section">
                    ...
                    <div className="row">
                        <img className="col-md-6" src={process.env.PUBLIC_URL + '/images/p1_old_admin_page.png'} alt="old admin page screenshot" />
                    </div>
                ...
                <section className="project-page-section">
                    ...
                    <div className="row">
                        <img className="col-lg-8" src={process.env.PUBLIC_URL + '/images/p1_new_admin_layout.png'} alt="new admin layout screenshot" />
                    </div>
                ...
                <section className="project-page-section">
                    ...
                    <div className="row">
                        <img className="col-lg-8" src={process.env.PUBLIC_URL + '/images/p1_new_admin_page.png'} alt="new admin page screenshot" />
                    </div>
